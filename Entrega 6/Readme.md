...
| Elemento | Florencia Aguirre | Erick Liu | Vicente Soza |
|---|---|---|---|
| Investigación del tema e hipótesis | X| X| X |
...
| Wireframe | X |  |  |
| Viaje de usuario |  |  | X |
| Video introductorio | X |  |  |
| Implementación HTML/CSS | X | X | X |
| Integración de imágenes y gráficos | X | X | X |
| Revisión narrativa final | X |  | X |
| Revisión final del sitio | X | X | X |
