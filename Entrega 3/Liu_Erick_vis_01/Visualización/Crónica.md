...
![Evolución del voto nulo en primera y segunda vuelta](evolucion_voto_nulo_primera_vs_segunda_vuelta.jpg)
...
Uno de los primeros datos a destacar es 1993. En esa elección, el voto nulo llega a uno de sus puntos más altos dentro de la serie, con cerca de 3,7% en primera vuelta. Luego, en 1999, baja con fuerza. Esto muestra que el voto nulo no depende solamente de que existan muchos candidatos, porque en ambos años hubo seis candidaturas en primera vuelta, pero el comportamiento del voto nulo fue distinto.

Entre 2005 y 2009, el voto nulo vuelve a moverse en niveles medios, cercanos al 2,5% y 2,8% en primera vuelta. Sin embargo, desde 2017 se observa una caída importante. En 2017 y 2021, los votos nulos se ubican bajo el 1% en primera vuelta. Es decir, durante esos años el voto nulo tuvo un peso mucho menor dentro del total de votos emitidos.

El cambio más fuerte aparece en 2025. En esa elección, el voto nulo sube de forma clara. En primera vuelta llega a cerca de 2,7%, pero en segunda vuelta alcanza casi 6%. Este salto es el dato más importante de la visualización, porque rompe con la tendencia baja que se venía observando desde 2017.

Este aumento debe leerse considerando dos factores. El primero es el voto obligatorio. Cuando votar vuelve a ser obligatorio, participan también personas que quizás no se sienten representadas por ninguna candidatura. En ese contexto, el voto nulo puede aparecer no solo como error, sino también como una forma de rechazo o distancia frente a la oferta electoral.

El segundo factor es la polarización. En la última elección incluida en la base, la segunda vuelta enfrentó a dos candidaturas ubicadas en polos fuertes de sus sectores: una vinculada al Partido Comunista y otra al Partido Republicano. Esto permite pensar que el aumento del voto nulo no se explica solo por la obligación de votar, sino también por el tipo de alternativas disponibles. 

El gráfico que compara cantidad de candidatos y voto nulo también ayuda a matizar la hipótesis. En 2017 y 2025 hubo una alta cantidad de candidatos en primera vuelta, pero el voto nulo fue muy distinto. En 2017 se mantiene bajo, mientras que en 2025 sube con fuerza. Esto refuerza que no es tan relevante cuantas candidaturas existen para la primer vuelta.
